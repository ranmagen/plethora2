...
//    animation: "",
//    color: "",
//    left: function () { return $("#" + this.id).offset().left; },
//    top: function () { return $("#" + this.id).offset().top; },
//    height: function () { return $("#" + this.id).height; },
//    create: function (id, type, color, size, startPosition, animation) {
//        this.id = id;
//        this.size = size;
//        this.color = color;
...
//        StartShapeAnimation(this.id, this.animation);
//    },
//    stopAnimation: function () {
//        $("#" + this.id).stop();
//    },
//    changeColor: function (newColor) {
//        $("#" + this.id).removeClass("red").removeClass("green").removeClass("yellow").removeClass("blue");
