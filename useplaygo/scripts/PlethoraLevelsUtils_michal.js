...
//var serverUrl = "http://localhost:8080/PlaygoServer2Load/playgo/playgoservice/";
...
function unBlurPage()
{
   ...
   function playgoRulesList () {
		this.userid = 0;
		this.rules = [];
		
		
		this.addRule = function(playgoRule) {
			this.rules.push(playgoRule);
		}
